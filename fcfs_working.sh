...
# user choice to run the program using any of 1. FCFS Scheduling 2. SJF Scheduling (Non-Preemptive and Preemptive) 3. Non- Preemptive Priority Scheduling 4. Round Robin Scheduling
echo "Enter your choice for scheduling algorithm
1. FCFS Scheduling
